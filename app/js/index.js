...
document.addEventListener('DOMContentLoaded', (event) => {
  if (debug) console.log('main-DOMContentLoaded()');
  fetchNeighborhoods();
  fetchCuisines();
  lazyLoadImages();
});
...
fillNeighborhoodsHTML = (neighborhoods = self.neighborhoods) => {
  if (debug) console.log('main-fillNeighborhoodsHTML()');
 ...
 */
fetchCuisines = () => {
  if (debug) console.log('main-fetchCuisines()');
...
fillCuisinesHTML = (cuisines = self.cuisines) => {
  if (debug) console.log('main-fillCuisinesHTML()');
 ...
 */
window.initMap = () => {
  if (debug) console.log('main-initMap()');
  let loc = {
    lat: 40.722216,
    lng: -73.987501
  };
 ...
 */
updateRestaurants = () => {
  if (debug) console.log('main-updateRestaurants()');
 ...
 */
resetRestaurants = (restaurants) => {
  if (debug) console.log('main-resetRestaurants()');
...
fillRestaurantsHTML = (restaurants = self.restaurants) => {
  if (debug) console.log('main-fillRestaurantsHTML()');
